...
def degrees(rad):
    return _wgs84.degrees(rad)
degrees = _wgs84.degrees

def radians(deg):
    return _wgs84.radians(deg)
radians = _wgs84.radians
...
def spherical_to_ecef(lat, lon, alt):
    return _wgs84.spherical_to_ecef(lat, lon, alt)
